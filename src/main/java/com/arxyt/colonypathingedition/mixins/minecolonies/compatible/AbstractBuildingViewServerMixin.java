...
public abstract class AbstractBuildingViewServerMixin {
    ...
    @Shadow(remap = false) private RotationMirror rotationMirror;
    ...
    @Shadow(remap = false) protected abstract void loadRequestSystemFromNBT(HolderLookup.@NotNull Provider provider, CompoundTag compound);
