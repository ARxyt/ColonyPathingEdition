...
public class ItemTooltipEvent {
    ...
    public static void onItemTooltipEvent(final net.minecraftforge.event.entity.player.ItemTooltipEvent event) {
        ...
        if (WindowCitizenInventory.activeCitizenInventory != null && ItemStackUtils.ISFOOD.test(stack))
        {
            ...
            double foodValue = NewFoodUtils.getFoodValue(stack, stack.getItem().getFoodProperties(), colony.getResearchManager().getResearchEffects().getEffectStrength(SATURATION));
