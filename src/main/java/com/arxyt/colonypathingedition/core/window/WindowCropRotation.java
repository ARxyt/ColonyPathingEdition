...
public class WindowCropRotation extends AbstractWindowSkeleton {
    ...
    private void setSeasonCount(TextField input){
        ...
        if (colonyView != null)
        {
            ...
            new CropRotationSeasonCountMessage(colonyView, farmField.getPosition(), season).sendToServer();
        }
    }
    ...
    private void setCurrentSeason(TextField input){
        ...
        if (colonyView != null)
        {
            ...
            new CropRotationCurrentSeasonMessage(colonyView, farmField.getPosition(), currentSeason).sendToServer();
        }
    }
    ...
    private void setCurrentDay(TextField input){
        ...
        if (colonyView != null)
        {
            ...
            new CropRotationCurrentDayMessage(colonyView, farmField.getPosition(), currentDay).sendToServer();
        }
    }
    ...
    private void setSeasonLength(final int thisSeason, TextField input){
        ...
        if (colonyView != null)
        {
            ...
            new CropRotationLengthUpdateMessage(colonyView, farmField.getPosition(), thisSeason, length).sendToServer();
        }
    }
    ...
    private void setSeed(int slot, ItemStack stack)
    {
        ...
        if (colonyView != null) {
            ...
            new CropRotationSeedUpdateMessage(colonyView, farmField.getPosition(), slot, stack).sendToServer();
        }
    }
