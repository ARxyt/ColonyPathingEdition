...
public class FoodBlackListMenuModuleView extends AbstractBuildingModuleView {
    ...
    public void deserialize(final @NotNull RegistryFriendlyByteBuf buf)
    {
        ...
        {
            black_list.add(new ItemStorage(ItemStack.OPTIONAL_STREAM_CODEC.decode(buf)));
        }
    }
    ...
    {
        return ResourceLocation.fromNamespaceAndPath(ColonyPathingEdition.MODID, "textures/gui/modules/black_list.png");
    }
