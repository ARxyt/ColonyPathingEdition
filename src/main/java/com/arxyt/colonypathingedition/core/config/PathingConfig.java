...
public class PathingConfig {
    public static ForgeConfigSpec.BooleanValue EATING_AI_MODULE;
        public static ForgeConfigSpec.DoubleValue DIVERSITY_REQUIREMENT;
        public static ForgeConfigSpec.DoubleValue QUALITY_REQUIREMENT;
        public static ForgeConfigSpec.DoubleValue FOOD_NUTRITION_NORMAL;
        public static ForgeConfigSpec.DoubleValue FOOD_NUTRITION_MINECOLONIES;
    ...
    public static ForgeConfigSpec.BooleanValue NETHER_WORKER_AI_MODULE;
    ...
    public static ForgeConfigSpec.BooleanValue NEW_WAREHOUSE_ASSIGN_MAX;
    ...
    public static ForgeConfigSpec.DoubleValue WAREHOUSE_ASSIGN_MULTIPLIER;
