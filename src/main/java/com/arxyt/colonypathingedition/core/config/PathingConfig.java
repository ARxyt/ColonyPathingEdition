...
public class PathingConfig {
    ...
    public static ModConfigSpec.ConfigValue<String> RESURRECT_ITEM;
    public static ModConfigSpec.DoubleValue RESURRECT_CHANCE_MULTIPLIER;
    public static ModConfigSpec.BooleanValue ALLOW_READ_MIND;
    public static ModConfigSpec.ConfigValue<String> READ_MIND_ITEM;

    public static ModConfigSpec.BooleanValue MESSAGE_DISPLAY;

    public static ModConfigSpec.DoubleValue RAIL_COST_MULTIPLIER;
    public static ModConfigSpec.DoubleValue WATER_COST_DEFINER;
    public static ModConfigSpec.DoubleValue JUMP_COST_DEFINER;
    public static ModConfigSpec.DoubleValue DROP_COST_MULTIPLIER;
    public static ModConfigSpec.DoubleValue ROAD_COST_MULTIPLIER;
    public static ModConfigSpec.DoubleValue INSHAPE_COST_DEFINER;
    public static ModConfigSpec.DoubleValue DOORS_COST_DEFINER;
    public static ModConfigSpec.DoubleValue DIVE_COST_DEFINER;
    public static ModConfigSpec.DoubleValue CAVE_COST_DEFINER;
    public static ModConfigSpec.DoubleValue RAILEXIT_COST_DEFINER;
    public static ModConfigSpec.DoubleValue LADDER_SWITCH_COST_DEFINER;
    public static ModConfigSpec.DoubleValue SHINGLE_COST_DEFINER;
    public static ModConfigSpec.DoubleValue FARMLAND_COST_DEFINER;
    public static ModConfigSpec.DoubleValue LEAF_COST_DEFINER;
    public static ModConfigSpec.DoubleValue BERRY_COST_DEFINER;

    public static ModConfigSpec.DoubleValue ONRAIL_CALLBACK_MULTIPLIER;
    public static ModConfigSpec.DoubleValue ONROAD_CALLBACK_MULTIPLIER;
    public static ModConfigSpec.DoubleValue ONRAIL_PREFERENCE;
    public static ModConfigSpec.DoubleValue ONROAD_PREFERENCE;
    public static ModConfigSpec.DoubleValue SWIMMING_PREFERENCE;
    public static ModConfigSpec.IntValue CALLBACK_TIMES_TOLERANCE;
    public static ModConfigSpec.IntValue NODE_EXTEND_COUNT;

    public static ModConfigSpec.DoubleValue RESTAURANT_WAITING_TIME;

    public static ModConfigSpec.DoubleValue MAX_PERCENTAGE_HP_FOR_CURE;
    public static ModConfigSpec.DoubleValue MAX_HP_FOR_CURE;
    public static ModConfigSpec.IntValue HEAL_START;
    public static ModConfigSpec.IntValue HEAL_DURATION;

    public static ModConfigSpec.BooleanValue LUMBERJACK_WORK_WHEN_UNCONSTRUCTED;
    public static ModConfigSpec.BooleanValue LUMBERJACK_PLANT_WITHOUT_SAPLINGS;
    ...
    public static ModConfigSpec.IntValue BUILDER_GIBBON_RANGE;
