...
public class SwitchUtils {
    ...
    public static void consumeFoodSwitcher(final ItemStack foodStack, final AbstractEntityCitizen citizen, final Inventory inventory){
        if(PathingConfig.EATING_AI_MODULE.get()) {
            NewFoodUtils.consumeFood(foodStack, citizen, inventory);
            return;
        }
